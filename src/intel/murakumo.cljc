...
(defn collection
  [name]
  (str "com.etzhayyim.intel." name))

(def cell-specs {
  :submitanalysis {:legacy-cell "com-etzhayyim-apps-intel-submitAnalysis"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "submitanalysis")]
     :required-gates common-gates
     :trigger "manifest cell submitanalysis"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-intel-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :analysis {:legacy-cell "com-etzhayyim-apps-intel-analysis"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "analysis")]
     :required-gates common-gates
     :trigger "manifest cell analysis"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :source {:legacy-cell "com-etzhayyim-apps-intel-source"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "source")]
     :required-gates common-gates
     :trigger "manifest cell source"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :alert {:legacy-cell "com-etzhayyim-apps-intel-alert"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "alert")]
     :required-gates common-gates
     :trigger "manifest cell alert"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :article {:legacy-cell "com-etzhayyim-apps-handotai-article"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "article")]
     :required-gates common-gates
     :trigger "manifest cell article"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :incident {:legacy-cell "com-etzhayyim-apps-malak-incident"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :risk {:legacy-cell "com-etzhayyim-apps-yabai-risk"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "risk")]
     :required-gates common-gates
     :trigger "manifest cell risk"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :ipanalysis {:legacy-cell "com-etzhayyim-apps-ipaddress-ipAnalysis"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "ipanalysis")]
     :required-gates common-gates
     :trigger "manifest cell ipanalysis"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
